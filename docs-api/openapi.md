    ...
    schemas:
        ...
        StructureNode:
            ...
            properties:
                G1_COD: { type: string }
                G1_COMP: { type: string }
                G1_OBSERV: { type: string, nullable: true }
                subStructure:
                    type: array
                    items:
        ...
        PaginatedProductsByGroup:
            ...
            properties:
                ...
                page: { type: integer, example: 1 }
                limit: { type: integer, example: 50 }
                total: { type: integer, example: 321 }
...
paths:
    /products:
        get:
            ...
            parameters:
                ...
                - in: query
                  name: orderBy
                  description: "Ordenação múltipla (CSV). Exemplos: B1_COD | B1_DESC desc | B1_GRUPO asc,B1_COD asc"
                  schema: { type: string, example: "B1_GRUPO asc,B1_COD asc" }
            responses:
                "200":
        ...
        get:
            ...
            responses:
                "200":
                    ...
                    content:
                        application/json:
                            schema: { $ref: "#/components/schemas/ProductWithStructure" }
                "401": { $ref: "#/components/responses/UnauthorizedError" }
        ...
        get:
            ...
            responses:
                "200":
                    ...
                    content:
                        application/json:
                            schema: { $ref: "#/components/schemas/PaginatedProductsByGroup" }
                "401": { $ref: "#/components/responses/UnauthorizedError" }
                "500": { $ref: "#/components/responses/InternalError" }
    ...
    /health:
        get:
            ...
            security: [] # <- remove bearerAuth só nesse endpoint
            responses:
                "200":
